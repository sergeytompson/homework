...
# TODO какой вариант я вижу - есть 2 списка снежинок: список падающих и список упавших, понять упала ли снежинка мы
#  можем по ее "y" координате
#  идея: рисуем снежиники из 2х списков - список с упавшими сначала пустой
#  по координате y проверяем упала ли снежинка, если упала, то убираем ее из списка падающих
#  и добавляем и список упавших, а на ее место добавляем в списке падающих генерируем новую
#  в итоге будут бесконечно рисоваться из 2х список из падающих (с анимацией)

...
class BowlingTest(unittest.TestCase):
    ...
    def test_normal(self):
        result = get_score('X2/34-12---X5/72-6')
    ...
    def test_finishing(self):
        result = get_score('1/2/3/4/5/6/7/8/9/1/')
    ...
    def test_wrong_type(self):
        self.assertRaises(TypeError, get_score, 1)

    def test_wrong_symbol(self):
        self.assertRaises(ValueError, get_score, '%XXXXXXXXX')

    def test_too_mach(self):
        self.assertRaises(ValueError, get_score, '99999999999999999999')

    def test_finishing_first(self):
        self.assertRaises(ValueError, get_score, '/')
